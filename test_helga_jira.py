...
@patch('helga_jira.settings', settings_stub)
@patch('helga_jira.db')
...
@patch('helga_jira.remove_re')
@patch('helga_jira.add_re')
...
@patch('helga_jira.settings', settings_stub)
@patch('helga_jira.HTTPBasicAuth')
@patch('helga_jira._rest_desc')
...
@patch('helga_jira.jira_match')
@patch('helga_jira.jira_command')
